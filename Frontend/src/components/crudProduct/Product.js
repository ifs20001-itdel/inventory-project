            ...
            <table className="table-auto w-full">
                ...
                <tbody>
                    {products.map((product, index) => (
                        <tr key={index}>
                            <td className="border px-4 py-2">{product.name_product}</td>
                            <td className="border px-4 py-2">{product.name_version}</td>
                            <td className="border px-4 py-2">{product.name_user}</td>
